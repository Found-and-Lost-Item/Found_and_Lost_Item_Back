...
router.post('/submitLostItem', upload.single('lostImageUrl'), (req, res) => {
    ...
    function insertLostBoard(imageUrl) {
        const lostboardQ = `
        ...
        db.query(lostboardQ, [lostCategory, lostTitle, lostContent, lostDate, lostLatitude, lostLongitude, lostAward], (err, lostboardR) => {
            ...
            if (imageUrl) {
                ...
                db.query(lostimageaddQ, [lostBoardId, imageUrl], (err) => {
                    if (err) {
