...
const findIdRouter = require('./routes/findId');
const findPasswordRouter = require('./routes/findPassword');
const lostBoardRouter = require('./routes/lostboard'); // 분실물 라우터 추가
const foundBoardRouter = require('./routes/foundboard'); // 습득물 라우터 추가
...
app.use('/find', findIdRouter); 
app.use('/find', findPasswordRouter); 
app.use('/add', lostBoardRouter);  // 분실물 등록 라우터 설정
app.use('/found', foundBoardRouter); // 습득물 등록 라우터 설정
